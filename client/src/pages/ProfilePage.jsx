            ...
            <div className='w-5/6 max-w-2xl backdrop-blur-2xl text-gray-300  border-2 border-gray-600 
                ...
                <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
                    ...
                    <textarea onChange={(e) => setBio(e.target.value)} value={bio}
                        placeholder='Write portfolio bio' required className='p-2 border border-gray-500 
                ...
                {/*----- for logo---- */}
                <img src={authUser?.profilePic || assets.logo_icon} className={`max-w-44 aspect-square rounded-full mx-10 mx-sm:mt-10 ${selectedImg && 'rounded-full'}`} alt='' />
            </div>
        </div>
    )
}
